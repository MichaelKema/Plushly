...
<header className="w-full bg-white dark:bg-gray-800 shadow-md flex justify-center items-center">
  <div className="container mx-auto px-4 py-4 flex flex-col items-center">
    <h1 className="text-2xl font-bold text-gray-800 dark:text-gray-100 text-center">Plushly</h1>
    <nav className="mt-4">
        ...
        <main className="flex-1 px-4 py-8 flex flex-col items-center">
          ...
          <section className="mb-8 w-full">
            <input
              ...
              className="block mx-auto w-full max-w-md px-4 py-2 border border-gray-300 dark:border-gray-600 rounded-md focus:outline-none focus:ring-2 focus:ring-primary-400 dark:bg-gray-700 dark:text-gray-100"
            />
          </section>
          ...
          <section className="w-full">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6 justify-items-center">
              ...
              <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-md overflow-hidden">
                ...
                />
                <div className="p-4">
                  <h3 className="text-lg font-medium text-gray-800 dark:text-gray-100">Plushie Name</h3>
